...
export function HomeVisualImageInstructions({
  ...
  return (
    <Alert className={className}>
      ...
      <AlertDescription>
        <p>
          Usá solo URLs de hosts permitidos: <strong>images.unsplash.com</strong>, <strong>cdn.jsdelivr.net</strong>, <strong>res.cloudinary.com</strong> y cualquier cuenta de <strong>imgix.net</strong>.
        </p>
        <p>
