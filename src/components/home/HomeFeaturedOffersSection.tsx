...
function buildOffers(items: OfferSource[]): HomeFeaturedOfferCard[] {
...
async function getOfferCards(): Promise<HomeFeaturedOfferCard[]> {
  try {
  ...
  return (
    <section className="py-8 sm:py-10 lg:py-12">
      <div className="container mx-auto px-4">
        ...
        <HomeFeaturedOffersCarousel offers={offers} />
      </div>
    </section>
  )
}
